...
const { setSubAction } = useTradeWsStore()
...
<template>
	<div>
		...
		<div
			v-show="tradeStore.state.KlineAction === klineTypeEnum.kline"
			id="kline_trade_container"
			class="w-full h-[466px]"></div>
		<!-- TradingView Widget END -->
		<DepthGraph v-if="tradeStore.state.KlineAction === klineTypeEnum.dept" class="w-full" />
		<div class="web:hidden flex items-center w-full px-4 border-t border-border-strong py-[6px]">
